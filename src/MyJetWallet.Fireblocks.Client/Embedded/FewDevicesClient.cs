...
{
    public partial class FewDevicesClient : BaseClient, IFewDevicesClient
    {
        ...
        public FewDevicesClient(ClientConfigurator clientConfigurator, HttpClient httpClient) : base(clientConfigurator)
        {
        ...
        public async Task<Response<List<FewDeviceResponse>>> GetRegisteredDevicesAsync(FewGetByWalletIdRequest request, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Response<FewDevicesGetKeySetupStateResponse>> GetDeviceKeySetupStateAsync(FewDeviceRequest request, CancellationToken cancellationToken = default)
        {
            if (request.WalletId == null)
                throw new ArgumentNullException("walletId");
        ...
        public async Task<Response<bool>> ChangeDeviceIsEnableAsync(FewDevicesCnahgeEnabledRequest request, CancellationToken cancellationToken = default)
        {
            if (request.WalletId == null)
                throw new ArgumentNullException("walletId");
