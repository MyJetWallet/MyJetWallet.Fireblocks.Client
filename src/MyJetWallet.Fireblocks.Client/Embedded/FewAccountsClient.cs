...
{
    public partial class FewAccountsClient : BaseClient, IFewAccountsClient
    {
        ...
        public FewAccountsClient(ClientConfigurator clientConfigurator, HttpClient httpClient) : base(clientConfigurator)
        {
        ...
        public async Task<Response<FewAccountsGetListResponse>> GetAccountsListAsync(FewGetListRequest request, string walletId, CancellationToken cancellationToken = default)
        {
            if (walletId == null)
                throw new ArgumentNullException("walletId");
