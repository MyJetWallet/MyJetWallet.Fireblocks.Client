...
namespace MyJetWallet.Fireblocks.Client.Embedded
{
    public partial class EmbeddedWalletClient : BaseClient, IEmbeddedWalletAdminClient, IEmbeddedWalletSignerClient
    {
        ...
        public virtual async Task<Response<CreateTransactionResponse>> TransactionsPostAsync(TransactionRequest body, System.Guid? x_End_User_Wallet_Id = null, string idempotency_Key = null, CancellationToken cancellationToken = default)
        {
            if (body == null)
